    ...
    return (
        <section className="w-4/5 mt-28 ml-auto mr-auto lg:flex lg:justify-around">
            <div className="flex flex-col lg:mt-10">
                ...
                <p className="text-white mt-6 lg:w-112">After some years working in IT area I got knowledge in some technologies. Every day I learn something new working in my personal projects and with some freelancers jobs. </p>
            </div>
